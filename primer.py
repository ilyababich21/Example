...
from examples import run_async_client, setup_async_client
...
async def _handle_holding_registers(client,SLAVE):
    """Read/write holding registers."""
    _logger.info("### write holding register and read holding registers")

    rr = _check_call(await client.read_holding_registers(0, 1, slave=SLAVE))
    print(rr.registers)
...
async def run_async_calls(client):
    ...
    await _handle_holding_registers(client,1)
    await _handle_holding_registers(client,0x02)
